# Derived from Murphy's Movies example: https://github.com/UCI-Chenli-teaching/cs122b-project5-murphy-movies/blob/Dockerized/Dockerfile
...
COPY --from=builder /app/target/cs122b-project1.war /usr/local/tomcat/webapps/cs122b-project1.war
